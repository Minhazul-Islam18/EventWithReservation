import { j as e, a as l, y as o } from "./app-d6cbffa8.js";
import m from "./Mainlayout-39be0ce6.js";
import { u as n } from "./index.esm-b3c0788f.js";
...
function d() {
    ...
    function i(a) {
        o.post("/admin/blog-category/store", a);
    }
    return e.jsxs(e.Fragment, {
        children: [
            ...
            e.jsx("div", {
                className: "pt-5 grid lg:grid-cols-2 grid-cols-1 gap-6",
                children: e.jsxs("div", {
                    className: "panel",
                    id: "forms_grid",
                    children: [
                        ...
                        e.jsx("div", {
                            ...
                            children: e.jsxs("form", {
                                ...
                                children: [
                                    e.jsx("div", {
                                        className:
                                            "grid grid-cols-1 sm:grid-cols-1 gap-4 items-center",
                                        children: e.jsxs("div", {
                                            children: [
                                                e.jsxs("label", {
                                                    children: [
...
d.layout = (r) => e.jsx(m, { children: r, title: "X || Add" });
export { d as default };
