import { r as j, j as e, a as u, y as v } from "./app-d6cbffa8.js";
import N from "./Mainlayout-39be0ce6.js";
import { S as f } from "./react-select.esm-8fb60c45.js";
import { R as b } from "./quill.snow-9910b5b5.js";
import { u as y, C } from "./index.esm-b3c0788f.js";
...
function w() {
    const {
        ...
        o = (s) => {
            i("category", s == null ? void 0 : s.value);
        };
    d("blog_details", "");
    const m = (s) => {
            i("blog_details", s);
    ...
    function p(s) {
        v.post("/admin/blog-post/store", s);
    }
...
w.layout = (a) => e.jsx(N, { children: a, title: "X || Edit" });
export { w as default };
