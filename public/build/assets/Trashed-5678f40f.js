import { q as z, r as a, j as e, a as h, y as A } from "./app-d6cbffa8.js";
...
function W() {
    const { data: o, meta: u, base_url: l } = z().props,
        [p, j] = a.useState(!1),
        [C, g] = a.useState(!o || o.length === 0),
        [S, x] = a.useState(!1),
        [y, N] = a.useState(u ? u.totalRowCount : 0),
        [i, v] = a.useState([]),
        [c, F] = a.useState(""),
        [d, D] = a.useState([]),
    ...
    a.useEffect(() => {
        (async () => {
            m.length ? x(!0) : g(!0);
            const s = new URL("/admin/brand/trashed/data", l);
    ...
    function k(t) {
        A.get("/admin/brand/undo-trashed/" + t);
    }
    function L(t) {
        M(t), f(!0);
    }
    ...
    return e.jsxs(e.Fragment, {
        children: [
            e.jsxs("div", {
                ...
                children: [
                    ...
                    e.jsxs("div", {
                        ...
                        children: [
                            e.jsx(h, {
                                href: `${l}/admin/brand/restore-all`,
                                method: "get",
                                className:
                            ...
                            e.jsx(h, {
                                href: `${l}/admin/brand/permanent-delete-all`,
                                method: "get",
                                className:
            ...
            e.jsx(O, {
                ...
                fileToDelete: T,
                name: "Brand",
                route: "brand/permanent-delete",
            }),
        ],
    });
}
W.layout = (o) => e.jsx(G, { children: o, title: "X || Trashed Language" });
export { W as default };
