import { q as A, r as s, j as e, a as h, y as B } from "./app-d6cbffa8.js";
...
function W() {
    const { data: n, meta: p, base_url: l } = A().props,
        [u, j] = s.useState(!1),
        [C, g] = s.useState(!n || n.length === 0),
        [S, x] = s.useState(!1),
        [y, N] = s.useState(p ? p.totalRowCount : 0),
        [i, v] = s.useState([]),
        [c, F] = s.useState(""),
        [d, D] = s.useState([]),
        [r, P] = s.useState({ pageIndex: 0, pageSize: 10 }),
        [R, f] = s.useState(!1),
        [T, M] = s.useState(null),
        [m, I] = s.useState(n || []);
    s.useEffect(() => {
        (async () => {
            m.length ? x(!0) : g(!0);
            const a = new URL("/admin/blog-post/trashed/data", l);
            a.searchParams.set("start", `${r.pageIndex * r.pageSize}`),
                a.searchParams.set("size", `${r.pageSize}`),
            ...
            try {
                ...
                if (b && b.includes("application/json")) {
                    ...
                    I(w.data), N(w.meta.totalRowCount);
    ...
    function k(t) {
        B.get("/admin/blog-post/undo-trashed/" + t);
    }
    function E(t) {
        M(t), f(!0);
    }
    const L = ({ data: t }) =>
            ...
            () => [
                {
                    ...
                    Cell: ({ row: t }) => {
                        ...
                        return e.jsx(L, {
                            data:
                                (a = t.original) == null ? void 0 : a.thumbnail,
                        });
                    },
                },
        ...
        z = U({
            ...
            mantineToolbarAlertBannerProps: u
    ...
    return e.jsxs(e.Fragment, {
        children: [
            e.jsxs("div", {
                ...
                children: [
                    ...
                    e.jsxs("div", {
                        ...
                        children: [
                            e.jsx(h, {
                                href: `${l}/admin/blog-post/restore-all`,
                                method: "get",
                                className:
                            ...
                            e.jsx(h, {
                                href: `${l}/admin/blog-post/permanent-delete-all`,
                                method: "get",
                                className:
            ...
            e.jsx(O, {
                ...
                fileToDelete: T,
                name: "blog-post",
                route: "blog-post/permanent-delete",
            }),
        ],
    });
}
W.layout = (n) => e.jsx(G, { children: n, title: "X || Trashed" });
export { W as default };
