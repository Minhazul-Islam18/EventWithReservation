import { q as l, j as e, a as m, y as d } from "./app-d6cbffa8.js";
import c from "./Mainlayout-39be0ce6.js";
import { u as o } from "./index.esm-b3c0788f.js";
    ...
    const { result: r } = l().props,
        {
            ...
            defaultValues: {
                ...
                iso: r.iso,
                symbol: r.symbol,
                converstion_rate: r.converstion_rate,
            },
        });
    function a(n) {
        d.post("/admin/currency/update", n);
    }
...
p.layout = (r) => e.jsx(c, { children: r, title: "X || Edit Currency" });
export { p as default };
