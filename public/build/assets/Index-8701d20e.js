import { q as W, r as s, j as e, a as m, y as w } from "./app-d6cbffa8.js";
import Z from "./Mainlayout-39be0ce6.js";
import { u as _, M as A } from "./mantine-react-table.esm-0ea93dbf.js";
...
function J() {
    const { data: l, meta: u, base_url: n } = W().props,
        [p, j] = s.useState(!1),
        [k, g] = s.useState(!l || l.length === 0),
        [y, f] = s.useState(!1),
        [S, v] = s.useState(u ? u.totalRowCount : 0),
        [i, N] = s.useState([]),
        [c, L] = s.useState(""),
        [d, R] = s.useState([]),
        [a, M] = s.useState({ pageIndex: 0, pageSize: 10 }),
        [F, x] = s.useState(!1),
        [P, D] = s.useState(null),
        [h, T] = s.useState(l || []);
    s.useEffect(() => {
        (async () => {
            h.length ? f(!0) : g(!0);
            const r = new URL("/admin/blog-post/data", n);
            r.searchParams.set("start", `${a.pageIndex * a.pageSize}`),
                r.searchParams.set("size", `${a.pageSize}`),
                r.searchParams.set("filters", JSON.stringify(i)),
                r.searchParams.set("globalFilter", c ?? ""),
                r.searchParams.set("sorting", JSON.stringify(d ?? []));
            try {
                const o = await fetch(r.href);
                ...
                if (C && C.includes("application/json")) {
                    ...
                    T(b.data), v(b.meta.totalRowCount);
    ...
    }, [i, c, a.pageIndex, a.pageSize, d]);
    function E(t) {
        w.get("/admin/blog-post/edit/" + t);
    }
    function I(t) {
        D(t), x(!0);
    }
    function B(t) {
        w.get("/admin/blog-post/status/" + t);
    }
    const $ = ({ data: t }) =>
            e.jsx("div", {
                children: e.jsx("img", {
            ...
            () => [
                {
                    ...
                    Cell: ({ row: t }) => {
                        ...
                        return e.jsx($, {
                            data:
                                (r = t.original) == null ? void 0 : r.thumbnail,
                        });
                    },
                },
            ...
            e.jsxs("div", {
                ...
                children: [
                    ...
                    e.jsxs("div", {
                        ...
                        children: [
                            e.jsxs(m, {
                                href: `${n}/admin/blog-post/trashed`,
                                method: "get",
                                className:
...
J.layout = (l) => e.jsx(Z, { children: l, title: "X || Blog Post" });
export { J as default };
