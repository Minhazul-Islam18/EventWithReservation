import { q as Z, r as a, j as e, a as h, y as m } from "./app-d6cbffa8.js";
import _ from "./Mainlayout-39be0ce6.js";
import { u as A, M as G } from "./mantine-react-table.esm-0ea93dbf.js";
import J from "./DeleteModal-3634c522.js";
...
function O() {
    const { data: l, meta: g, base_url: o } = Z().props,
        [p, j] = a.useState(!1),
        [k, f] = a.useState(!l || l.length === 0),
        [y, x] = a.useState(!1),
        [S, v] = a.useState(g ? g.totalRowCount : 0),
        [i, N] = a.useState([]),
        [c, L] = a.useState(""),
        [d, R] = a.useState([]),
        [r, F] = a.useState({ pageIndex: 0, pageSize: 10 }),
        [M, C] = a.useState(!1),
        [D, T] = a.useState(null),
        [u, I] = a.useState(l || []);
    a.useEffect(() => {
        (async () => {
            u.length ? x(!0) : f(!0);
            const s = new URL("/admin/language/data", o);
            ...
            try {
                ...
                if (b && b.includes("application/json")) {
                    ...
                    I(w.data), v(w.meta.totalRowCount);
    ...
    function P(t) {
        m.get("/admin/language/translate/" + t);
    }
    function E(t) {
        m.get("/admin/language/edit/" + t);
    }
    function $(t) {
        T(t), C(!0);
    }
    function z(t) {
        m.get("/admin/language/status/" + t);
    }
    const B = ({ data: t }) =>
            e.jsx("div", {
                children: e.jsx("img", {
            ...
            () => [
                {
                    ...
                    Cell: ({ row: t }) => {
                        var s;
                        return e.jsx(B, {
                            data: (s = t.original) == null ? void 0 : s.icon,
                        });
                    },
                },
                    ...
                    Cell: ({ row: t }) => {
                        ...
                        return e.jsxs("div", {
                            ...
                            children: [
                                ...
                                ((s = t == null ? void 0 : t.original) == null
                                    ? void 0
                                    : s.is_default) !== 1 &&
                                    e.jsxs(e.Fragment, {
                                        children: [
        ...
        W = A({
            ...
            mantineSearchTextInputProps: {
                placeholder: `Search ${u.length} rows`,
                sx: { minWidth: "300px" },
                variant: "filled",
            },
            manualFiltering: !0,
...
O.layout = (l) => e.jsx(_, { children: l, title: "X || Language" });
export { O as default };
