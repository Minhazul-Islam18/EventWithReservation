import { q as o, j as e, a as m, y as n } from "./app-d6cbffa8.js";
...
function p() {
    const { result: r } = o().props,
        {
            register: s,
            handleSubmit: i,
            formState: { errors: t },
        } = c({ defaultValues: { id: r.id, name: r.name } });
    function a(l) {
        n.post("/admin/blog-category/update", l);
    }
...
p.layout = (r) => e.jsx(d, { children: r, title: "X || Edit" });
export { p as default };
