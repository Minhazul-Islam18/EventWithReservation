import { q as A, r, j as e, a as u, y as w } from "./app-d6cbffa8.js";
import W from "./Mainlayout-39be0ce6.js";
import { u as Z, M as G } from "./mantine-react-table.esm-0ea93dbf.js";
import _ from "./DeleteModal-3634c522.js";
...
function J() {
    const { data: n, meta: m, base_url: l } = A().props,
        [p, j] = r.useState(!1),
        [y, g] = r.useState(!n || n.length === 0),
        [k, f] = r.useState(!1),
        [S, v] = r.useState(m ? m.totalRowCount : 0),
        [i, N] = r.useState([]),
        [c, L] = r.useState(""),
        [d, R] = r.useState([]),
        [a, M] = r.useState({ pageIndex: 0, pageSize: 10 }),
        [F, x] = r.useState(!1),
        [D, P] = r.useState(null),
        [h, T] = r.useState(n || []);
    r.useEffect(() => {
        (async () => {
            h.length ? f(!0) : g(!0);
            const s = new URL("/admin/category/data", l);
            s.searchParams.set("start", `${a.pageIndex * a.pageSize}`),
                s.searchParams.set("size", `${a.pageSize}`),
                s.searchParams.set("filters", JSON.stringify(i)),
                s.searchParams.set("globalFilter", c ?? ""),
                s.searchParams.set("sorting", JSON.stringify(d ?? []));
            try {
                const o = await fetch(s.href);
    ...
    function E(t) {
        w.get("/admin/category/edit/" + t);
    }
    function I(t) {
        P(t), x(!0);
    }
    function $(t) {
        w.get("/admin/category/status/" + t);
    }
    const z = ({ data: t }) =>
            e.jsx("div", {
                children: e.jsx("img", {
...
J.layout = (n) => e.jsx(W, { children: n, title: "X || All Category" });
export { J as default };
