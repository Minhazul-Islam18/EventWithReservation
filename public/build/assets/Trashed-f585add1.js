import { q as z, r as t, j as e, a as u, y as A } from "./app-d6cbffa8.js";
import B from "./Mainlayout-39be0ce6.js";
...
function O() {
    const { data: o, meta: h, base_url: i } = z().props,
        [p, y] = t.useState(!1),
        [C, g] = t.useState(!o || o.length === 0),
        [j, x] = t.useState(!1),
        [S, N] = t.useState(h ? h.totalRowCount : 0),
        [l, F] = t.useState([]),
        [c, v] = t.useState(""),
        [m, D] = t.useState([]),
    ...
    t.useEffect(() => {
        (async () => {
            d.length ? x(!0) : g(!0);
            const a = new URL("/admin/currency/trashed/data", i);
            a.searchParams.set("start", `${s.pageIndex * s.pageSize}`),
                a.searchParams.set("size", `${s.pageSize}`),
                a.searchParams.set("filters", JSON.stringify(l)),
                a.searchParams.set("globalFilter", c ?? ""),
                a.searchParams.set("sorting", JSON.stringify(m ?? []));
            try {
                ...
                if (w && w.includes("application/json")) {
                    ...
                    k(b.data), N(b.meta.totalRowCount);
    ...
    }, [l, c, s.pageIndex, s.pageSize, m]);
    function I(r) {
        A.get("/admin/currency/undo-trashed/" + r);
    }
    function E(r) {
        T(r), f(!0);
    }
            ...
            e.jsxs("div", {
                ...
                children: [
                    ...
                    e.jsxs("div", {
                        ...
                        children: [
                            e.jsx(u, {
                                href: `${i}/admin/currency/restore-all`,
                                method: "get",
                                className:
                            ...
                            e.jsx(u, {
                                href: `${i}/admin/currency/permanent-delete-all`,
                                method: "get",
                                className:
...
O.layout = (o) => e.jsx(B, { children: o, title: "X || Trashed" });
export { O as default };
