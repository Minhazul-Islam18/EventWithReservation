import { q as $, r, j as e, a as u, y as w } from "./app-d6cbffa8.js";
import A from "./Mainlayout-39be0ce6.js";
import { u as W, M as Z } from "./mantine-react-table.esm-0ea93dbf.js";
import G from "./DeleteModal-3634c522.js";
...
function _() {
    const { data: l, meta: m, base_url: n } = $().props,
        [p, j] = r.useState(!1),
        [y, g] = r.useState(!l || l.length === 0),
        [k, f] = r.useState(!1),
        [S, v] = r.useState(m ? m.totalRowCount : 0),
        [i, N] = r.useState([]),
        [c, L] = r.useState(""),
        [d, M] = r.useState([]),
        [s, R] = r.useState({ pageIndex: 0, pageSize: 10 }),
        [F, x] = r.useState(!1),
        [D, P] = r.useState(null),
        [h, E] = r.useState(l || []);
    r.useEffect(() => {
        (async () => {
            h.length ? f(!0) : g(!0);
            const a = new URL("/admin/blog-category/data", n);
            a.searchParams.set("start", `${s.pageIndex * s.pageSize}`),
                a.searchParams.set("size", `${s.pageSize}`),
                a.searchParams.set("filters", JSON.stringify(i)),
                a.searchParams.set("globalFilter", c ?? ""),
                a.searchParams.set("sorting", JSON.stringify(d ?? []));
            try {
                const o = await fetch(a.href);
                ...
                if (C && C.includes("application/json")) {
                    ...
                    E(b.data), v(b.meta.totalRowCount);
    ...
    }, [i, c, s.pageIndex, s.pageSize, d]);
    function T(t) {
        w.get("/admin/blog-category/edit/" + t);
    }
    function B(t) {
        P(t), x(!0);
    }
    function I(t) {
        w.get("/admin/blog-category/status/" + t);
    }
    const z = r.useMemo(
            () => [
                { accessorKey: "name", header: " Blog Category Name" },
                {
                    header: "Status",
                    Cell: ({ row: t }) =>
                        e.jsx("div", {
        ...
        H = W({
            ...
            mantineSearchTextInputProps: {
                placeholder: `Search ${h.length} rows`,
                sx: { minWidth: "300px" },
                variant: "filled",
            },
            manualFiltering: !0,
            ...
            e.jsxs("div", {
                ...
                children: [
                    ...
                    e.jsxs("div", {
                        ...
                        children: [
                            e.jsxs(u, {
                                href: `${n}/admin/blog-category/trashed`,
                                method: "get",
                                className:
                            ...
                            e.jsxs(u, {
                                href: `${n}/admin/blog-category/create`,
                                method: "get",
                                className:
...
_.layout = (l) => e.jsx(A, { children: l, title: "X || All Blogs" });
export { _ as default };
