...
import { u as Z, M as A } from "./mantine-react-table.esm-0ea93dbf.js";
...
function _() {
    const { data: o, meta: m, flash: J, base_url: l } = $().props,
        [p, j] = r.useState(!1),
        [y, f] = r.useState(!o || o.length === 0),
        [k, x] = r.useState(!1),
    ...
    r.useEffect(() => {
        (async () => {
            h.length ? x(!0) : f(!0);
            const a = new URL("/admin/currency/data", l);
    ...
    function T(t) {
        w.get("/admin/currency/edit/" + t);
    }
    function I(t) {
        P(t), g(!0);
    }
    function z(t) {
        w.get("/admin/currency/status/" + t);
    }
    const B = r.useMemo(
            () => [
...
_.layout = (o) => e.jsx(W, { children: o, title: "X || Currency" });
export { _ as default };
