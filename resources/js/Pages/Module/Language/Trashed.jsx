...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL("/admin/brand/trashed/data", base_url);
    ...
    function handleUndoClick(data) {
        router.get("/admin/brand/undo-trashed/" + data);
    }
        ...
        () => [
            {
                header: "Thumbnail",
                Cell: ({ row }) => (
                    <ImageRenderer data={row.original?.thumbnail} />
                ),
            },
            {
                accessorKey: "name",
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/brand/restore-all`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/brand/permanent-delete-all`}
                        method="get"
...
Index.layout = (page) => (
    <MainLayout children={page} title="Event reservation || Trashed Language" />
);
