...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL("/admin/language/data", base_url);
    ...
    function handleTranslationClick(data) {
        router.get("/admin/language/translate/" + data);
    }
    function handleEditClick(data) {
        router.get("/admin/language/edit/" + data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/language/status/" + data);
    }
    ...
    const columns = useMemo(
        () => [
            {
                header: "Icon",
                Cell: ({ row }) => <ImageRenderer data={row.original?.icon} />,
            },
            {
                accessorKey: "name",
                header: " Name",
            ...
            },
            {
                ...
                Cell: ({ row }) => (
                    <div className="flex items-center gap-2">
                        <button
                            onClick={() => handleTranslationClick(row.id)}
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/language/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/language/create`}
                        method="get"
...
Index.layout = (page) => <MainLayout children={page} title="X || Language" />;
