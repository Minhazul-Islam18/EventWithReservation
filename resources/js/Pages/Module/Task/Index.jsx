...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL("https://keoscrm.com/api/projects");

            const headers = new Headers();
            headers.append(
                "authtoken",
                "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiU3lzdGVtIGRldiIsIm5hbWUiOiJUYW5oYSIsIkFQSV9USU1FIjoxNzE2NzA5NDExfQ.3L7sXVi9dLwxrQ0c7vnbsNYt2FLyacMjbqDtMdqCECQ"
            );
        ...
        console.log(data[0].assignees[0].full_name);
        // fetchData();
    }, [
        columnFilters,
        globalFilter,
