...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL("/admin/currency/data", base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/currency/edit/" + data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/currency/status/" + data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/currency/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/currency/create`}
                        method="get"
...
Index.layout = (page) => <MainLayout children={page} title="X || Currency" />;
