...
function Index() {
        ...
        const fetchLinkData = async () => {
            try {
                const response = await axios.get(
                    "/admin/social-link/get-social-link-data"
                );
    ...
    const [selectedImage, setSelectedImage] = useState(
        result?.headerLogo
            ? `/storage/brand/${result?.headerLogo}`
    ...
    const [footerImage, setFooterImage] = useState(
        result?.footerLogo
            ? `/storage/brand/${result?.footerLogo}`
            : "/assets/images/user-profile.jpeg"
    );
    ...
    const [invoiceImage, setInvoiceImage] = useState(
        result?.invoiceLogo
            ? `/storage/brand/${result?.invoiceLogo}`
            : "/assets/images/user-profile.jpeg"
    );
    ...
    const [popupBanner, setPopupBanner] = useState(
        result?.popupBanner
            ? `/storage/brand/${result?.popupBanner}`
            : "/assets/images/popUpBanner.jpg"
    );
    ...
    const [adminLoader, setAdminLoader] = useState(
        result?.adminLoader
            ? `/storage/brand/${result?.adminLoader}`
            : "/assets/images/Loader.gif"
    );
    ...
    const [breadcumb, setBreadcumb] = useState(
        result?.breadcumb
            ? `/storage/brand/${result?.breadcumb}`
            : "/assets/images/popUpBanner.jpg"
    );
    ...
    const [errorBanner1, setErrorBanner1] = useState(
        result?.errorBanner1
            ? `/storage/brand/${result?.errorBanner1}`
            : "/assets/images/404Error.jpg"
    );
    const [errorBanner2, setErrorBanner2] = useState(
        result?.errorBanner2
            ? `/storage/brand/${result?.errorBanner2}`
            : "/assets/images/404Error.jpg"
    );
    //-------------------------
    ...
    const [featuredImage, setFeaturedImage] = useState(
        result?.featuredImage
            ? `/storage/brand/${result?.featuredImage}`
            : "/assets/images/404Error.jpg"
    );
                    ...
                    <div className="flex flex-col h-full pb-16">
                        <PerfectScrollbar className="relative ltr:pr-3.5 rtl:pl-3.5 ltr:-mr-3.5 rtl:-ml-3.5 h-full grow">
                            <div className="space-y-1">
                                <button
                                    type="button"
                                    className={`w-full flex justify-between items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-[#FF6243] hover:text-[#FF6243] dark:hover:bg-[#181F32] font-medium h-10 ${
                                        selectedTab === "inbox"
                                            ? "bg-gray-100 dark:text-[#FF6243] text-[#FF6243] dark:bg-[#181F32]"
                                            : ""
                                    }`}
                                    onClick={() => {
                                    ...
                                    <>
                                        ...
                                        >
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    <label>
                                                        Product Based Affilate
                                                    </label>

                                                    <select
                                                        className="form-select text-white-dark"
                                                        {...register(
                                                            "product_based_affilate",
                                                            {
                                                                required:
                                                                    "Product Based Affilate required",
                                                            }
                                                        )}
                                                    >
                                                        <option value="1">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        {...register(
                                                            ...
                                                            {
                                                                required:
                                                                    "Google ReCapcha Site Key Is required",
                                                            }
                                                        )}
                                                        type="text"
                                                        className="form-input"
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        {...register(
                                                            ...
                                                            {
                                                                required:
                                                                    "Google ReCapcha Secret Key Is required",
                                                            }
                                                        )}
                                                        type="text"
                                                        className="form-input"
...
Index.layout = (page) => (
    <MainLayout children={page} title="Settings || Event reservation" />
);
